# modify based on gfl_head.py. Generalized Focal Loss: Learning Qualified and Distributed Bounding Boxes for Dense Object Detection. https://arxiv.org/abs/2006.04388
...
class DCFAHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(DCFAHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        self.concat_fuse_cls = ConvModule(
        ...
        self.concat_fuse_reg = ConvModule(
            self.feat_channels*2,
            self.feat_channels,
            1,
            stride=1,
    ...
    def init_weights(self):
        ...
        normal_init(self.concat_fuse_cls.conv, std=0.01)
        normal_init(self.concat_fuse_reg.conv, std=0.01)
    ...
    def forward_single(self, x, scale):
        ...
        for i in range(self.stacked_convs):
            ...
            if i==0:
                ...
                cls_featX = torch.cat( (cls_featX, cls_feat), dim=-3)
                cls_featX = self.concat_fuse_cls(cls_featX)
                
                reg_featX = torch.cat( (reg_featX, reg_feat), dim=-3)                    
                reg_featX = self.concat_fuse_reg(reg_featX)
